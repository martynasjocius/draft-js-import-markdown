...
var _syntheticDom2 = require('synthetic-dom');
...
InlineLexer.prototype.parse = function (src) {
  var out = new _syntheticDom2.FragmentNode();
  var link;
  var cap;
  ...
  while (src) {
    ...
    if (cap = this.rules.escape.exec(src)) {
      src = src.substring(cap[0].length);
      out.appendChild(new _syntheticDom2.TextNode(cap[1]));
      continue;
    }
    ...
    if ((cap = this.rules.reflink.exec(src)) || (cap = this.rules.nolink.exec(src))) {
      ...
      if (!link || !link.href) {
        out.appendChild(new _syntheticDom2.TextNode(cap[0].charAt(0)));
    ...
    if (cap = this.rules.text.exec(src)) {
      src = src.substring(cap[0].length);
      out.appendChild(this.renderer.text(new _syntheticDom2.TextNode(cap[0])));
      continue;
    }
...
Renderer.prototype.code = function (childNode, lang) {
  ...
  var codeNode = new _syntheticDom2.ElementNode('code', attributes, [childNode]);
  return new _syntheticDom2.ElementNode('pre', [], [codeNode]);
};

Renderer.prototype.blockquote = function (childNode) {
  return new _syntheticDom2.ElementNode('blockquote', [], [childNode]);
};

Renderer.prototype.heading = function (childNode, level) {
  return new _syntheticDom2.ElementNode('h' + level, [], [childNode]);
};

Renderer.prototype.hr = function () {
  return new _syntheticDom2.ElementNode('hr', [], _syntheticDom2.SELF_CLOSING);
};

Renderer.prototype.list = function (childNode, isOrdered) {
  return new _syntheticDom2.ElementNode(isOrdered ? 'ol' : 'ul', [], [childNode]);
};

Renderer.prototype.listitem = function (childNode) {
  return new _syntheticDom2.ElementNode('li', [], [childNode]);
};

Renderer.prototype.paragraph = function (childNode) {
  return new _syntheticDom2.ElementNode('p', [], [childNode]);
};

// span level renderer
Renderer.prototype.strong = function (childNode) {
  return new _syntheticDom2.ElementNode('strong', [], [childNode]);
};

Renderer.prototype.em = function (childNode) {
  return new _syntheticDom2.ElementNode('em', [], [childNode]);
};

Renderer.prototype.codespan = function (text) {
  return new _syntheticDom2.ElementNode('code', [], [new _syntheticDom2.TextNode(text)]);
};

Renderer.prototype.br = function () {
  return new _syntheticDom2.ElementNode('br', [], _syntheticDom2.SELF_CLOSING);
};

Renderer.prototype.del = function (childNode) {
  return new _syntheticDom2.ElementNode('del', [], [childNode]);
};

Renderer.prototype.ins = function (childNode) {
  return new _syntheticDom2.ElementNode('ins', [], [childNode]);
};
...
Renderer.prototype.link = function (href, title, childNode) {
  ...
  return new _syntheticDom2.ElementNode('a', attributes, [childNode]);
};
...
Parser.prototype.tok = function () {
  switch (this.token.type) {
    case 'space':
      {
        return new _syntheticDom2.TextNode('');
      }
    case 'hr':
      {
    ...
    case 'blockquote_start':
      {
        var body = new _syntheticDom2.FragmentNode();
    ...
    case 'list_start':
      {
        var _body = new _syntheticDom2.FragmentNode();
    ...
    case 'list_item_start':
      {
        var _body2 = new _syntheticDom2.FragmentNode();
    ...
    case 'loose_item_start':
      {
        var _body3 = new _syntheticDom2.FragmentNode();
...
var MarkdownParser = {
  parse: function parse(src, options) {
    ...
    try {
      ...
      if (options.silent) {
        fragment = new _syntheticDom2.FragmentNode([new _syntheticDom2.ElementNode('p', [], [new _syntheticDom2.TextNode('An error occured:')]), new _syntheticDom2.ElementNode('pre', [], [new _syntheticDom2.TextNode(e.message)])]);
      } else {
        throw e;
      }
    }
    if (options.getAST) {
      return new _syntheticDom2.ElementNode('body', [], [fragment]);
    } else {
